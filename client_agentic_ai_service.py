...
class ClientAgenticAIConfig:
    def __init__(self):
        ...
        try:
            ...
            print(f"Warning: Client Agentic Gemini client initialization failed: {e}")
            self.client = None
    ...
    def is_configured(self):
        """Check if client agentic AI is properly configured"""
        return self.client is not None and self.api_key is not None

client_agentic_ai_config = ClientAgenticAIConfig()

class ClientAgenticAIService:
    def __init__(self):
        self.client = client_agentic_ai_config.client if client_agentic_ai_config.is_configured() else None
    ...
    def process_user_request(self, company_id: int, user_message: str, conversation_history: Optional[List[Dict]] = None, language: str = 'en') -> Dict[str, Any]:
        ...
        try:
            if not client_agentic_ai_config.is_configured():
...
client_agentic_ai_service = ClientAgenticAIService()